...
async def advantage_spell_chok(msg):
    ...
    btn = [[
        ...
        k = await msg.reply_text(text="""<b>ഹലോ {} നിങ്ങൾ ആവശ്യപ്പെട്ട ഈ സിനിമ എനിക്ക് കണ്ടെത്താൻ കഴിഞ്ഞില്ല 🥴 ...
