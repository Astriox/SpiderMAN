...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [[InlineKeyboardButton('ᴄᴏɴᴛᴀᴄᴛ ᴏᴡɴᴇʀ', url='https://t.me/iampancho')]]
    ...
    buttons = [
                    [
                        ...
                        InlineKeyboardButton('🎨 ᴅᴀʀᴋ ᴍᴏᴅᴇ', url="https://t.me/addtheme/gxneodarker")
                    ],
                    [
...
@Client.on_message(filters.command('submit') & filters.private & filters.user(ADMINS))
...
@Client.on_message(filters.command('reply') & filters.private & filters.user(ADMINS))
